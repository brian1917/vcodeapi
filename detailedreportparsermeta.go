...
// ParseDetailedReportMeta parses the detailedreport.do API and returns an array of Flaws
func ParseDetailedReportMeta(credsFile, buildID string) (DetReportMeta, error) {
	var errMsg error
